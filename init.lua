...
vim.o.number = true
-- You can also add relative line numbers, to helprexc with jumping.
...
-- User Request: Global Statusline (spans full width)
...
vim.keymap.set('n', '<leader>wd', '<C-w>d', { desc = 'delete' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ga', vim.lsp.buf.code_action, 'action', { 'n', 'x' })
      ...
      vim.diagnostic.config {
        ...
        -- User Requirement: No icons. Using text signs.
        signs = {
          text = {
      ...
      vim.list_extend(ensure_installed, {
        ...
        'prettier', -- User Requirement: Prettier
        'goimports', -- User Requirement: Go Formatting
      })
    ...
    config = function()
      ...
      miniclue.setup {
        ...
        clues = {
          ...
          { mode = 'n', keys = '<Leader>s', desc = 'flash' },
        },

        window = {
          delay = 0,
          config = { width = 'auto', border = 'double' },
        },
      }
    end,
  },
